        ...
        <div className="container mx-auto mt-10">
          <div className="flex-wrap my-10 w-3/4shadow-md">
            <div className="px-10 py-1 bg-white ">
              ...
              <Link to={'/products'} className="flex mt-10 text-sm font-semibold text-gray-900">
            ...
            <div id="summary" className="container w-2/4 px-8 py-10">
              ...
              <div className="mt-8 border-t">
                ...
                <Link to='/checkout'
                 className="w-full p-2 py-3 text-sm font-semibold text-white uppercase bg-indigo-500 hover:bg-indigo-600">Checkout</Link>
              </div>
            </div>
          </div>
       </div>
